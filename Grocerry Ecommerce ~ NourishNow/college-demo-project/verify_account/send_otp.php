...
/*     $mail->SMTPDebug = SMTP::DEBUG_SERVER;*/                      //Enable verbose debug output
    ...
    $mail->Subject = 'Authentication Nourishnow ';
    $mail->Body    = 'Dear Customer,<br>Thank you for choosing <b>NourishNow</b>!'.$massage.']. Enter it on our website to complete your verification.<br> Happy shopping! <br>Regards,<b>NourishNow</b> Team .   ';
    $mail->AltBody = 'Dear Customer,<br>Thank you for choosing <b>NourishNow</b>!'.$massage.']. Enter it on our website to complete your verification.<br> Happy shopping! <br>Regards,<b>NourishNow</b> Team .   ';
